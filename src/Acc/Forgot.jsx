    ...
    return(
        ...
        <div className="sign">
            <div className="container" style={{height:"400px"}}>
                ...
                <div className="upper"><input className='email' type="mail" placeholder="Email" pattern="[a-zA-Z0-9@.]" required style={{ backgroundColor:"#fff", marginTop:"50px", marginBottom:"40px"}}/>
